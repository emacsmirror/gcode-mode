...
(defun gcode-mode--doc-entries () '(
  ...
  ("G61" "Return to Saved Position" ?F "Move feedrate" ?S "Use saved position of the specified memory slot (defaults to 0 if not spificied)" ?X "Axes to restore")
  ...
  ("M104" "Set Hotend Temperature" ?B "AUTOTEMP: The max auto-temperature" ?F "AUTOTEMP: Autotemp flag" ?I "Material preset index" ?S "Target temperature.AUTOTEMP: the min auto-temperature" ?T "Hotend index")
  ...
  ("M118" "Serial print" ?A "Prepend // to denote a comment or action command" ?E "Prepend echo: to the message" ?s "Message string")
  ("M119" "Endstop States")
  ...
  ("M140" "Set Bed Temperature" ?I "Material preset index" ?S "Target temperature.AUTOTEMP: the min auto-temperature")
